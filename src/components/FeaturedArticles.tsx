...
type FeaturedArticlesProps = {
  ...
  limit?: number;   // Optional limit for number of articles to display
};
...
export default async function FeaturedArticles({
  ...
  // Filter only featured articles and apply optional limit
      ...
      <div className="container-main">
        ...
        <div className="border-t border-[#7FA091]">
          ...
          {featuredArticles.map((article: any) => {
            // Extract plain text from all paragraph slices
            const articleText =
              article.data.body
            ...
            return (
              // Individual article preview block
              <article
                key={article.id}
